 ...
 *   - animate Block 1 profit counter (+0.0% → +13.9%)
...
export default function LandingViewD() {
    ...
    // Block 1 profit counter ("+0.0%" → "+13.9%")
    ...
    // Risk banner — restore dismissed state from localStorage on mount
    useEffect(() => {
        try {
            if (localStorage.getItem("aaa_risk_banner_dismissed") === "1") {
                setBannerOpen(false);
            }
        } catch {
            /* ignore */
    ...
    // Block 1 profit counter — animates 0.0% → 13.9% over ~1.8s once
        ...
        <div className="landing-d-root" id="lbRoot" ref={rootRef} onClick={handleRootClick}>
            ...
            {bannerOpen && (
                ...
                >
                    ...
                    >
                        Invest with confidence. Read the full risk disclosure ›
                    </a>
                    <button
                        type="button"
                        id="lbRiskClose"
            ...
            {/* Mobile-only open-source pill, sits under the nav on ≤900px.
                Hidden on desktop via .lb-mob-pill { display: none } default,
                shown only inside the @media (max-width: 900px) block. */}
            <div className="lb-mob-pill" aria-hidden="true">
                <span className="lb-mob-pill-dot"></span>
                Open-source community edition · launching mid-2026 ›
            </div>
                            ...
                            >
                                ...
                                >
                                    <a
                                        ...
                                        href="mailto:info@aaagents.de?subject=AAAgents%20contact"
                                    >
                                        Contact us
                                    </a>
                                    <a
            ...
            {/* BLOCK 2 — LESS RISK (was Safety; now dark) */}
            <section
                className="tr-section dark"
                id="block-safe"
                style={{ padding: "260px 60.8px" }}
            >
                <div className="tr-grid">
                    <div className="tr-stage">
                        <div className="rpipe">
            ...
            {/* Fade transition: dark → light */}
            <div className="tr-fade tr-fade-dark-to-light" aria-hidden="true"></div>

            {/* BLOCK 3 — COMPLIANCE (was Auto; now light) */}
            ...
            {/* BLOCK 4 — MODULARITY / COMPATIBILITY (white) */}
            <section className="tr-section" id="block-modular">
                <div className="tr-grid">
                    <div className="tr-stage">
                    ...
                    <div className="tr-text">
                        <h2 className="tr-headline">Compatibility with<br />everything.</h2>
                        <p className="tr-intro">
                    ...
                    <div className="tr-body">
                        <p className="pt">
                            <b>Modular by design.</b> Specialists, senate, optimizer, and
                            executor are independent layers — each one swappable for your own
                            implementation while the rest of the platform keeps running.
                        </p>
                        <p className="pt">
                            <b>Broker-agnostic.</b> Execution sits behind a generic broker
                            interface. Alpaca and IBKR ship in-box; any FIX or REST venue plugs
                            in through a thin adapter.
                        </p>
                        <p className="pt">
                            <b>Bring your own data.</b> Market-data feeds, sentiment providers,
                            alternative datasets — the analyst layer normalises every input
                            before the senate ever sees it.
                        </p>
                        <p className="pt">
                            <b>Open APIs, no lock-in.</b> Every state transition is exposed
                            through a signed REST endpoint plus the audit chain. Run the
                            platform, trigger it from your own systems, leave whenever.
                        </p>
                    </div>
                </div>
            </section>
