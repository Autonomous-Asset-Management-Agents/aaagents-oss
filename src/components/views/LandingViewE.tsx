        ...
        <div className="landing-d-root" id="lbRoot" ref={rootRef} onClick={handleRootClick}>
                    ...
                    <div className="lb-ticker-track">
                        ...
                        {[0, 1].map((i) => (
                            <span key={i} className="lb-ticker-item" aria-hidden={i === 1 ? "true" : undefined}>
                                For developers: open-source community launched &mdash; download on GitHub
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                                For developers: open-source community launched &mdash; download on GitHub
                                &nbsp;&nbsp;&nbsp;·&nbsp;&nbsp;&nbsp;
                            </span>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            style={{
                                display: "grid",
                                gridTemplateColumns: "0.9fr 1.05fr",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <b style={{ color: "#0a0a0a", fontWeight: 600 }}>aaagents_</b>{" "}
                    ...
                    <div className="lb-hero-inner-2" aria-hidden="true">
                        <div className="lb-hero-inner-2-track">
                            <h2 className="lb-hero-h2">
                                Build a full hedgefund<br />at your disposal.
                            </h2>
                        </div>
                    </div>
                </section>
            ...
            <section className="tr-section" id="block-profit">
                <div className="tr-grid">
                    <div className="tr-stage">
                        <div className="perfgraph">
                            ...
                            <div className="pg-legend">
                                <span className="pg-legend-item"><i className="pg-legend-dot"></i>aaagents_</span>
                    ...
                    <div className="tr-text">
                        <h2 className="tr-headline">High Profitability.</h2>
                        <p className="tr-intro">
                            <b>aaagents_</b> outperforms because every motion runs through ≈500
                    ...
                    <div className="tr-body">
                        ...
                        <p className="pt">
                            <b>Hedge-fund expertise, encoded.</b> The platform mirrors the
                            structure of a real hedge fund — analysts, quants, portfolio managers,
                            risk officers — each represented by a specialised, dedicated agent.
                        </p>
                        <p className="pt">
                            <b>Outperforms the benchmark.</b> aaagents_'s active and autonomous
                            trading strategy outperforms the benchmark index whilst reducing
                            investor risk — a higher Sharpe ratio.
                        </p>
                        <p className="pt">
            ...
            >
                <div className="tr-grid reverse">
                    ...
                    <div className="tr-text">
                        <h2 className="tr-headline">Less Risk.</h2>
                        <p className="tr-intro">
                            <b>aaagents_</b> turns risk control into a structural property —
            ...
            <section className="tr-section" id="block-auto">
                <div className="tr-grid">
                    <div className="tr-text">
                        <h2 className="tr-headline">Compliance<br />by design.</h2>
                        <p className="tr-intro">
                            Wrapping unconstrained AI in a rigorous regulatory net, the dedicated compliance layer guarantees every executed trade is structurally safe for institutional deployment.
                        </p>
                    </div>
                    ...
                    <div className="tr-body">
                        ...
                        <p className="pt">
                            <b>MiFID II, DORA Art. 15, EU AI Act Art. 12.</b> Triple-write audit
                            chain replays any decision forever. Compliant by construction, not
                            by checklist.
                        </p>
                    </div>
                ...
                <div className="tr-grid reverse">
                    <div className="tr-stage">
                        <div className="modhub">
                            <div className="modhub-lbl">INTEGRATION HUB · LIVE</div>
                            <svg className="modhub-svg" viewBox="0 0 480 360" aria-hidden="true">
                                ...
                                <g className="modhub-spokes">
                                    <line x1="240" y1="180" x2="80"  y2="60"  />
                                    <line x1="240" y1="180" x2="400" y2="60"  />
                                    <line x1="240" y1="180" x2="40"  y2="180" />
                                    <line x1="240" y1="180" x2="440" y2="180" />
                                    <line x1="240" y1="180" x2="80"  y2="300" />
                                    <line x1="240" y1="180" x2="400" y2="300" />
                                </g>
                                ...
                                <text x="240" y="194" textAnchor="middle" className="modhub-core-tag">core</text>

                                {/* satellite nodes — letter badges (legend below labels them) */}
                                <g className="modhub-mod" transform="translate(80 60)">
                                    <title>Execution adapter — Alpaca in-box; IBKR or any REST broker via thin adapter</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">EX</text>
                                </g>
                                <g className="modhub-mod" transform="translate(400 60)">
                                    <title>Market-data feed — Polygon and IEX in-box; bring your own provider</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">MD</text>
                                </g>
                                <g className="modhub-mod" transform="translate(40 180)">
                                    <title>News and sentiment — FinBERT-class processors; replaceable</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">NS</text>
                                </g>
                                <g className="modhub-mod" transform="translate(440 180)">
                                    <title>Coordinator LLM — Ollama on-prem by default; swap to any local or hosted model</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">LM</text>
                                </g>
                                <g className="modhub-mod" transform="translate(80 300)">
                                    <title>Audit and storage — hash-chained JSONL local sink plus Cloud Logging</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">DB</text>
                                </g>
                                <g className="modhub-mod" transform="translate(400 300)">
                                    <title>Identity and access — Firebase Auth in-box; pluggable</title>
                                    <circle r="26" />
                                    <text y="5" textAnchor="middle" className="modhub-mod-icon">ID</text>
                                </g>

                                {/* travelling data dots — animate along each spoke */}
                                <circle className="modhub-flow modhub-flow-1" r="3" />
                                <circle className="modhub-flow modhub-flow-2" r="3" />
                                <circle className="modhub-flow modhub-flow-3" r="3" />
                                <circle className="modhub-flow modhub-flow-4" r="3" />
                                <circle className="modhub-flow modhub-flow-5" r="3" />
                                <circle className="modhub-flow modhub-flow-6" r="3" />
                            </svg>
                            <div className="modhub-legend">
                                <span><b>EX</b>execution · Alpaca · IBKR planned</span>
                                <span><b>MD</b>market data · Polygon · IEX</span>
                                <span><b>NS</b>news · NewsProcessor</span>
                                <span><b>LM</b>LLM · Ollama · on-prem</span>
                                <span><b>DB</b>audit · JSONL + Cloud Logging</span>
                                <span><b>ID</b>identity · Firebase</span>
                            </div>
                        </div>
                    </div>

                    <div className="tr-text">
                        <h2 className="tr-headline">Seamless<br />Integration.</h2>
                        <p className="tr-intro">
                            <b>aaagents_</b> is built as a set of independent modules —
                            broker-agnostic, data-agnostic, and exposed through open APIs so it
                            slots into any existing trading stack.
                        </p>
                    </div>

                    <div className="tr-body">
                        <p className="pt">
                            <b>Modular by design.</b> Data analysis, decision engines, risk 
                            management, and execution are independent layers — each component 
                            can be customized or entirely replaced to fit your proprietary logic 
                            without disrupting the platform.
                        </p>
                        <p className="pt">
                            <b>Broker-agnostic.</b> Trade execution is routed through a standardized 
                            gateway. Native integrations for major institutional brokers are included, 
                            and any custom FIX or REST venue connects easily via a lightweight adapter.
                        </p>
                        <p className="pt">
                            <b>Bring your own data.</b> Market-data feeds, sentiment providers, and 
                            alternative datasets — the ingestion layer normalizes all incoming streams 
                            before they ever reach the core decision algorithms.
                        </p>
                        <p className="pt">
                            <b>Open APIs, no lock-in.</b> Every system state and trade action is fully 
                            exposed through secure REST endpoints and an immutable audit trail. Operate 
                            the platform autonomously, or integrate it seamlessly into your existing infrastructure.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="tr-section dark" id="block-editions">
                <div className="tr-grid-single" style={{ display: "block", maxWidth: 1200, margin: "0 auto" }}>

                    {/* Positioning cards: aaagents-oss + Enterprise */}
                    <div className="ed-tiers" aria-label="aaagents-oss vs Enterprise">
                        <article className="ed-tier ed-tier-oss">
                            <header className="ed-tier-head">
                                <span className="ed-tier-eyebrow">aaagents-oss</span>
                                <h3 className="ed-tier-name">Open Source &amp; Portable</h3>
                                <p className="ed-tier-tag">
                                    The trading core, fully open-source, built on the BORA principle —
                                    <i> Build Once, Run Anywhere.</i> Powered by Docker, it deploys
                                    across any environment with minimal friction.
                                </p>
                            </header>
                            <div className="ed-tier-body">
                                <a className="ed-cta"
                                   href="https://github.com/Autonomous-Asset-Management-Agents/aaagents-oss"
                                   target="_blank"
                        ...
                        <article className="ed-tier ed-tier-ent">
                            <header className="ed-tier-head">
                                ...
                                <h3 className="ed-tier-name">Compliance &amp; Cloud</h3>
                                <p className="ed-tier-tag">
                                    Extends the core with a cloud-native architecture that can be
                                    fully operated within your own infrastructure.
                                </p>
                            </header>
                            <div className="ed-tier-body">
                                <ul className="ed-feat-list">
                                    <li>
                                        <strong>Regulatory-Grade Audit Logging</strong>
                                        <span>Comprehensive compliance tracking and tamper-proof logs.</span>
                                    </li>
                                    <li>
                                        <strong>Trading Intelligence Layer</strong>
                                        <span>Advanced analytics and decision logic for institutional environments.</span>
                                    </li>
                                    <li>
                                        <strong>Hybrid Deployment</strong>
                                        <span>Cloud-native efficiency with full data sovereignty.</span>
                                    </li>
                                </ul>
                            </div>
                        </article>
                    ...
                    {/* Full Transparence — headline + intro for the detailed matrix */}
                    <div className="tx-headline-block">
                        <h2 className="tr-headline tx-headline">Full<br />Transparence.</h2>
                        <p className="tr-intro tx-intro">
                            See exactly how it works. The <b>aaagents_</b> core is fully
                            open-source — audit the logic, benchmark the performance, verify
                            the compliance rules. Transparency isn't a feature. It's the
                            foundation.
                        </p>
                    </div>

                    {/* Detailed feature matrix — module-card layout, per-category */}
                    <div className="tx-matrix" role="table" aria-label="Community vs Enterprise feature matrix">
                        <div className="tx-matrix-bar">
                            <span className="tx-matrix-pulse" aria-hidden="true"></span>
                            <span className="tx-matrix-eyebrow">Feature Matrix · 6 Modules · Code-Verified</span>
                            <span className="tx-matrix-cols">
                                <span className="tx-matrix-col-oss">OSS</span>
                                <span className="tx-matrix-col-ent">ENT</span>
                            </span>
                        </div>

                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">01</span>
                                <h4 className="tx-module-name">Infrastructure</h4>
                                <span className="tx-module-tag">runtime · sync · telemetry · swap</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Runtime</div>
                                    <div className="tx-val tx-val-oss">Local Docker Compose</div>
                                    <div className="tx-val tx-val-ent">GCP Cloud Run · Cloud SQL · Memorystore</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">ML model sync</div>
                                    <div className="tx-val tx-val-oss">GitHub release manifest</div>
                                    <div className="tx-val tx-val-ent">GCS bucket + Vertex AI training jobs</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Telemetry</div>
                                    <div className="tx-val tx-val-oss">Local logs</div>
                                    <div className="tx-val tx-val-ent">OpenTelemetry · Cloud Trace · Slack alerts</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Strategy hot-swap</div>
                                    <div className="tx-val tx-val-oss">Restart required</div>
                                    <div className="tx-val tx-val-ent">Live API swap with MiFID audit log</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">02</span>
                                <h4 className="tx-module-name">Auth &amp; Secrets</h4>
                                <span className="tx-module-tag">identity · credentials · tenancy</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Identity provider</div>
                                    <div className="tx-val tx-val-oss">LocalMockAuth (loopback-bound)</div>
                                    <div className="tx-val tx-val-ent">Firebase Auth · per-user UID scoping</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Broker credentials</div>
                                    <div className="tx-val tx-val-oss">.env file</div>
                                    <div className="tx-val tx-val-ent">GCP Secret Manager · per-user · DSGVO revoke</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Multi-tenancy</div>
                                    <div className="tx-val tx-val-oss tx-empty">—</div>
                                    <div className="tx-val tx-val-ent">Firebase-UID routing on shared schema</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">03</span>
                                <h4 className="tx-module-name">Market Data</h4>
                                <span className="tx-module-tag">equity · volatility · sentiment</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Equity feed</div>
                                    <div className="tx-val tx-val-oss">Alpaca IEX (paper)</div>
                                    <div className="tx-val tx-val-ent">Alpaca SIP · Polygon · Databento</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Volatility input</div>
                                    <div className="tx-val tx-val-oss">SPY-volatility proxy</div>
                                    <div className="tx-val tx-val-ent">CBOE VIX (real)</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">News &amp; sentiment</div>
                                    <div className="tx-val tx-val-oss">Best-effort, no quota</div>
                                    <div className="tx-val tx-val-ent">Full Gemini quota · Redis cache · per-tenant</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">04</span>
                                <h4 className="tx-module-name">AI &amp; Trading Intelligence</h4>
                                <span className="tx-module-tag">round table · adaptive · exit · A/B</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Round Table agents</div>
                                    <div className="tx-val tx-val-oss">9 senators (basic weights)</div>
                                    <div className="tx-val tx-val-ent">9 senators + Stock-Specialist registry · ~500 specialists</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Adaptive intelligence</div>
                                    <div className="tx-val tx-val-oss tx-empty">—</div>
                                    <div className="tx-val tx-val-ent">TradeIntelligence · per-symbol self-tuning · pattern detection</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Exit logic</div>
                                    <div className="tx-val tx-val-oss">Static rules</div>
                                    <div className="tx-val tx-val-ent"><code>analyze_exit()</code> multi-factor · <code>should_sell_smart()</code> overlay</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">A/B testing</div>
                                    <div className="tx-val tx-val-oss tx-empty">—</div>
                                    <div className="tx-val tx-val-ent">ABTestExperiment · same-history model comparison</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">05</span>
                                <h4 className="tx-module-name">Risk &amp; Compliance</h4>
                                <span className="tx-module-tag">iron-dome · WORM · MiFID · RTS</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Iron-Dome risk layers</div>
                                    <div className="tx-val tx-val-oss">Identical · 5-stage pre-trade gate</div>
                                    <div className="tx-val tx-val-ent">Identical · DB-configurable limits</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Audit log (WORM)</div>
                                    <div className="tx-val tx-val-oss">Local JSONL · SHA-256 hash chain</div>
                                    <div className="tx-val tx-val-ent">Cloud SQL · DB-level WORM trigger</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">MiFID II RTS&nbsp;6 hot-swap audit</div>
                                    <div className="tx-val tx-val-oss tx-empty">—</div>
                                    <div className="tx-val tx-val-ent">Position-lock · audit log on every swap</div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">RTS&nbsp;22 export · NCA XML</div>
                                    <div className="tx-val tx-val-oss tx-empty">—</div>
                                    <div className="tx-val tx-val-ent"><span className="ed-soon">Roadmap Q3 2026</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="tx-module">
                            <header className="tx-module-head">
                                <span className="tx-module-num">06</span>
                                <h4 className="tx-module-name">Brokerage &amp; Support</h4>
                                <span className="tx-module-tag">execution · SLA</span>
                            </header>
                            <div className="tx-module-body">
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Execution adapter</div>
                                    <div className="tx-val tx-val-oss">Alpaca</div>
                                    <div className="tx-val tx-val-ent">Alpaca · IBKR <span className="ed-soon">planned</span></div>
                                </div>
                                <div className="tx-row" role="row">
                                    <div className="tx-row-name">Support</div>
                                    <div className="tx-val tx-val-oss">GitHub Discussions</div>
                                    <div className="tx-val tx-val-ent">SLA · dedicated channel</div>
                                </div>
                            </div>
                        </section>
                    </div>
            ...
            <footer className="lb-footer" style={{ padding: "80px var(--lb-gutter) 40px" }}>
                <div className="lb-footer-grid">
                    ...
                    <div>
                        <h4>Platform</h4>
                        <a href="#" data-open="profit">Profitability</a>
                        <a href="#" data-open="auto">Autonomous</a>
                        <a href="#" data-open="safe">Safety</a>
                    </div>
                    <div>
                        <h4>Open Source</h4>
                        <span
