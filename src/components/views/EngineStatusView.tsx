              ...
              {!isConnected && !isChecking && (
                <div className="bg-muted/50 rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
                  ...
                  <ol className="list-decimal list-inside space-y-1 sm:space-y-2 text-muted-foreground text-sm sm:text-base">
                    <li>From <code className="bg-background px-2 py-1 rounded text-xs">AI Trading Bot</code> folder run: <code className="bg-background px-2 py-1 rounded text-xs sm:text-sm">python -m core.engine</code></li>
