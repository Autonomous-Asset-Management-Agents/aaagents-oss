  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!useChatOnly && command.includes("start")) {
        ...
        const data = await res.json();
        response = data.reply ?? data.message ?? "I couldn't get an answer. Try asking about portfolio, strategy, news, or any market question.";
      }
    } catch (e) {
