...
By submitting a Pull Request to this repository, you explicitly agree to the following terms:
1. **License Grant:** You agree that your contributions are licensed under the terms of the Apache License, Version 2.0.
2. **Rights Grant for Enterprise Edition:** You grant the authors (Andreas Apeldorn, Georg Apeldorn) and the maintainer (Autonomous Asset Management Agents UG (haftungsbeschränkt)) a perpetual, worldwide, irrevocable, royalty-free, transferable, and sublicensable license to use, modify, distribute, and re-license your contribution under both the Apache 2.0 license (for this Community Edition) and any commercial/proprietary license (for the Enterprise Edition).
3. **Developer Certificate of Origin (DCO):** You certify that you have the legal right to submit this code and that the contribution does not infringe any third-party intellectual property rights.
