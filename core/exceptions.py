...
class BrokerError(TradingBotError):
    """Raised when the broker API (Alpaca) rejects an order or returns an error."""


class StateCorruptionError(TradingBotError):
    """Raised when LangGraph or global state invariants are violated."""
