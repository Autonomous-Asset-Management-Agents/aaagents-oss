...
|---|---|---|
| Runtime | ✅ Local Docker Compose | ✅ GCP Cloud Run (auto-scaling) |
| Database | ✅ Local PostgreSQL on 127.0.0.1 | ✅ Cloud SQL |
...
| OAuth Token Storage | 🔴 NotImplementedError (fail-closed stub) | ✅ GCP Secret Manager |
...
| SpecialistAlphaAgent | 0.55 | ⚠️ weight=0 until registry warm | ✅ Active with data pipeline |
...
| Ollama / local LLM | 🔴 Not planned | Gemini API in both editions |
...
*Last updated: 2026-05-07 | Source of truth (internal): `docs/0_strategy_and_roadmap/value_chain/vc7_editions.md`*
