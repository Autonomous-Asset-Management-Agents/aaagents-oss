...
class TestMonitorLoopStrategySwitchStability:
    ...
    def test_strategy_name_matches_config_active_strategy(self):
        ...
        with patch("core.strategies.rl_strategy.os.path.exists", return_value=False), \
             patch("core.strategies.rl_strategy.get_trade_intelligence", return_value=MagicMock()), \
             patch("core.strategies.rl_strategy.HistoricalDataProvider", return_value=MagicMock()):
