...
def test_append_live_equity_to_benchmark_triggers_snapshot():
    """Test _append_live_equity_to_benchmark successfully triggers log_portfolio_snapshot."""
    mock_redis = MagicMock()
    mock_redis.get.return_value = json.dumps({"points": []})
    ...
    # Instantiate a mocked BotEngine
    ...
    with patch(
        ...
        # Check that log_portfolio_snapshot was called with correct structure
