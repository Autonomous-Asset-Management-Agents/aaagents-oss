...
class TestRiskManager:
    ...
    def test_circuit_breaker_tier2(self, mock_trip, risk_manager):
        ...
        risk_manager.client.close_all_positions.assert_called_once_with(cancel_orders=True)
    ...
    @patch("core.risk_manager.AILearnedRules.get_rules")
    def test_evaluate_new_trade_ai_rules_additional_actions(self, mock_get_rules, risk_manager):
